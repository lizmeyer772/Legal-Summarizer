  ...
  return (
    <div className="app-shell">
      <header className="app-header">
        ...
        <p>
          Upload a document, generate an LLM summary, and review practical
          attorney follow-up guidance.
        </p>
      </header>
      ...
      <main className="app-layout">
        <section className="panel upload-panel">
          ...
          <p className="panel-intro">
            Upload a complaint or other legal document, then run the analysis.
          </p>
        ...
        <section className="panel output-panel">
          <div className="panel-heading-row">
            <div>
              <h2>2. LLM Output</h2>
              <p className="panel-intro">
                Summary and practical follow-up guidance for attorney review.
              </p>
            </div>
            ...
            <button
              ...
              disabled={!canSavePdf || isSummarizing}
            >
              Save PDF
            </button>
          </div>
          ...
          <div className="output-grid">
            <div className="result-box">
              ...
              {isSummarizing ? (
                ...
                <p className="placeholder">
                  Summary from LLM will be shown here.
                </p>
              )}
            </div>
            ...
            <div className="result-box">
              ...
              {isSummarizing ? (
                ...
                <p className="placeholder">
                  Next steps and follow-up questions will be shown here.
                </p>
              )}
            </div>
          </div>
...
function buildAnalysisPdf({ fileName, summary, nextSteps, generatedAt }) {
  ...
  addText("Legal Document Analysis", {
    size: 18,
    bold: true,
    lineHeight: 22,
    gapAfter: 8,
  ...
  addText(`Generated: ${generatedAt.toLocaleString()}`, {
    size: 10,
    lineHeight: 14,
  });
  addSpacer(8);
